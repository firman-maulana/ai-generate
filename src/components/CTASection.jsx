...
export default function CTASection() {
  return (
    <section className="max-[1920px]:px-5">
      <div
        className="bg-secondary max-w-[1880px] rounded-3xl xl:rounded-4xl lg:py-24 xl:py-28 px-5 mx-auto"
        data-ns-animate
        data-delay="0.2"
      >
        <div className="max-w-[1400px] mx-auto py-16 lg:py-20 xl:py-30">
          ...
          >
            Helping businesses harness AI-powered marketing solutions to enhance engagement,
            increase conversions, and achieve new heights of growth and success.
          </h2>
        </div>
      </div>
    </section>
