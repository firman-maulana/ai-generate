    ...
    <nav className="hidden items-center xl:flex">
      <ul className="flex items-center">
        ...
        >
          ...
          <div>
            <div className="dropdown-menu-bridge pointer-events-none fixed top-full left-1/2 z-40 h-3 w-full -translate-x-1/2 bg-transparent opacity-0 lg:w-[946px]" />
            <div
              id="company-mega-menu-v2"
              className="dropdown-menu dark:bg-background-6 border-stroke-1 pointer-events-none fixed top-full left-1/2 z-50 mt-2 flex w-full -translate-x-1/2 items-start gap-y-6 rounded-[20px] border bg-white p-4 opacity-0 transition-all duration-300 md:gap-x-6 lg:w-[946px] dark:border-white/10"
            >
              <div className="flex-1 space-y-3">
                <ul className="space-y-2">
                  <li>
                    ...
                    >
                      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-background-3 dark:bg-background-7 opacity-0 group-hover:opacity-100 rounded-[10px] z-0 transition-all duration-400 {=$class}" />
                      ...
                      <div className="relative z-10">
                        <p className="text-tagline-1 text-secondary dark:text-accent font-normal">
                          About Us
                        </p>
                      ...
                      <div className="border-stroke-1 relative z-10 mt-1 flex size-7 shrink-0 items-center justify-center rounded-lg border p-1 dark:border-white/10">
                        ...
                        >
                          ...
                          <path
                            ...
                            className="fill-secondary dark:fill-accent {=$class}"
                          />
                          <path
              ...
              <div className="flex-1">
                ...
                <p className="text-tagline-2 text-secondary/60 dark:text-accent/60 p-3 font-medium">
                  What’s new
                </p>
                <div>
        ...
        >
          ...
          <div>
            <div className="dropdown-menu-bridge fixed left-1/2 -translate-x-1/2 top-full w-full h-3 z-40 lg:w-[1290px] pointer-events-none bg-transparent opacity-0" />
            <div
              id="platform-mega-menu-v2"
              className="dropdown-menu fixed left-1/2 -translate-x-1/2 top-full mt-2 pointer-events-none transition-all duration-300 opacity-0 lg:w-[1290px] w-full bg-white dark:bg-background-6 z-50 rounded-[20px] p-4 border border-stroke-1 dark:border-white/10"
            >
              <div className="grid grid-cols-12 items-start md:gap-x-6 gap-y-6">
                <div className="col-span-12 lg:col-span-6 grid grid-cols-12 gap-x-6">
                  <div className="col-span-12 xl:col-span-6">
                    <div>
                      <p className="text-tagline-2 font-medium text-secondary/60 dark:text-accent/60 p-3">
                        Overview
                      </p>
                      <ul>
                        <li>
                          <a
                            href="./features.html"
                            className="relative block group p-3"
                          >
                            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-background-3 dark:bg-background-7 opacity-0 group-hover:opacity-100 rounded-[10px] z-0 transition-all duration-400 {=$class}" />
                            <span className="text-tagline-1 font-normal text-secondary dark:text-accent relative z-10">
                    ...
                    <div>
                      ...
                      <ul>
                        <li>
                          <a
                            href="./pricing.html"
                            className="relative flex items-center gap-2 group p-3"
                          >
                            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-background-3 dark:bg-background-7 opacity-0 group-hover:opacity-100 rounded-[10px] z-0 transition-all duration-400 {=$class}" />
                          ...
                          >
                            ...
                            <span className="relative z-10">
                              <svg
                                ...
                                fill="none"
                              >
                                <g clipPath="url(#clip0_3582_21197)">
                                  <path
                ...
                <div className="col-span-12 lg:col-span-6 grid grid-cols-12 gap-x-6">
                  <div className="col-span-12 xl:col-span-6">
                    <a href="./blog-details.html" className="block"></a>
                    <article className="p-3 border border-stroke-1 dark:border-background-7 rounded-2xl space-y-3 group">
                      ...
                      <div className="space-y-14">
                        <a href="./blog-details.html" className="block">
                          <div>
                            <p className="text-heading-6 font-normal text-secondary dark:text-accent">
                              Merge Unified
                            </p>
                            <p className="text-tagline-1 font-normal text-secondary/60 dark:text-accent/60">
                        ...
                        <div>
                          ...
                          <a
                            ...
                            className="bg-secondary group group-hover:bg-primary-500 transition-all duration-500 ease-in-out ring-[6px] ring-background-12 dark:ring-background-7 rounded-full w-16 relative overflow-hidden flex items-center justify-center space-y-5 h-9.5 px-5 py-2"
                          >
        ...
        >
          ...
          <div>
            <div className="dropdown-menu-bridge absolute left-1/2 -translate-x-1/2 top-full w-full h-3 z-40 min-w-[280px] pointer-events-none bg-transparent opacity-0" />
            <ul
              id="resources-dropdown-menu-v2"
              className="dropdown-menu mt-2 w-[280px] rounded-[20px] p-3 bg-white dark:bg-background-6 shadow-14 absolute left-1/2 -translate-x-1/2 top-full z-50 pointer-events-none opacity-0 border border-stroke-1 dark:border-background-7"
            >
              <li>
                <a
                  href="./blog.html"
                  className="p-3 rounded-[10px] flex items-center gap-2 relative group"
                >
                  <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-background-3 dark:bg-background-7 opacity-0 group-hover:opacity-100 rounded-[10px] z-0 transition-all duration-400 {=$class}" />
                  <span className="relative z-10">
                    <svg
                ...
                >
                  ...
                  <span className="relative z-10">
                    <svg
                      ...
                      fill="none"
                    >
                      <g clipPath="url(#clip0_4483_34377)">
                        <path
        ...
        >
          ...
          <div>
            <div className="dropdown-menu-bridge fixed left-1/2 -translate-x-1/2 top-full w-full h-3 z-40 min-w-[952px] pointer-events-none bg-transparent opacity-0" />
            <div
              id="product-mega-menu"
              className="dropdown-menu fixed left-1/2 -translate-x-1/2 top-full mt-2 pointer-events-none transition-all duration-300 opacity-0 md:w-[952px] w-full bg-white dark:bg-background-6 z-50 rounded-[20px] p-4 border border-stroke-1 dark:border-background-7 space-y-6"
            >
              <div className="flex items-start md:gap-x-6 gap-y-6">
                <ul className="space-y-2 flex-1">
                  <li>
                    <a
                      href="./login.html"
                      className="p-3 rounded-[10px] flex items-start gap-3 transition-all duration-300 relative group"
                    >
                      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-background-3 dark:bg-background-7 opacity-0 group-hover:opacity-100 rounded-[10px] z-0 transition-all duration-400 {=$class}" />
                      ...
                      <div className="relative z-10 space-y-0.5">
                        ...
                        <p className="text-tagline-3 font-normal text-secondary/60 dark:text-accent/60">
                ...
                <figure className="flex-1 w-full space-y-3">
                  <p className="text-tagline-2 font-medium text-secondary/60 dark:text-accent/60">
                    What's New
                  </p>
                  <a href="./changelog.html">
                    <figure className="overflow-hidden rounded-[14px] max-w-full w-full min-h-[200px] relative group">
                      <img
                        src="/images/ns-img-419.jpg"
                        alt="What's New"
                        className="w-full h-full object-cover rounded-[14px] group-hover:scale-105 transition-all duration-500 ease-in-out"
                      />
                      <div className="absolute group-hover:top-5 group-hover:left-5 top-4 left-4 size-full space-y-1 transition-all duration-500 ease-in-out">
                        <p className="text-white text-tagline-1 font-medium">
                          AI Application Changelog
                        </p>
                        <p className="text-white/60 max-w-[212px] w-full text-tagline-3 font-normal">
                          Access all your workflows, analytics, and integrations
...
Mobile Menu
===========================*/}
  <aside className="sidebar dark:bg-background-7 scroll-bar fixed top-0 right-0 z-[999] h-screen w-full translate-x-full bg-white transition-all duration-300 sm:w-1/2 xl:hidden">
    <div className="space-y-4 p-5 sm:p-8 lg:p-9">
      <div className="flex items-center justify-between">
        ...
        <button className="nav-hamburger-close bg-background-4 dark:bg-background-9 relative flex size-10 cursor-pointer flex-col items-center justify-center gap-1.5 rounded-full">
      ...
      <div className="scroll-bar h-[85vh] w-full overflow-x-hidden overflow-y-auto pb-10">
        <ul>
          ...
          <li className="relative space-y-0">
            ...
            <div className="hidden ml-3.5 transition-all duration-300 w-full bg-white dark:bg-background-7 overflow-y-auto">
              <ul>
                <li>
                  <a
                    href="./index.html"
                    className="text-tagline-1 font-normal text-secondary/60 dark:text-accent/60 transition-all duration-200 py-3 border-b border-stroke-4 dark:border-stroke-6 w-full text-left block"
                  >
                    1. Crypto Marketing
                  </a>
                </li>
                ...
                <li>
                  <a
                    ...
                    className="text-tagline-1 font-normal text-secondary/60 dark:text-accent/60 transition-all duration-200 py-3 w-full text-left block"
                  >
          ...
          <li className="relative space-y-0">
            ...
            <div className="hidden ml-3.5 transition-all duration-300 w-full bg-white dark:bg-background-7 max-h-[500px] overflow-y-auto scroll-bar">
              <ul>
                <li>
                  <a
          ...
          {/* sign up menu  */}
          <li className="relative space-y-0">
            <button className="sub-menu text-tagline-1 font-normal text-secondary/60 dark:text-accent/60 transition-all duration-200 py-3 w-full text-left flex items-center justify-between cursor-pointer">
              <span>Sign up</span>
              <span className="sub-menu-arrow transition-all duration-300">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
