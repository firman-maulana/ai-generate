...
export default function Footer() {
  return (
    <>
      <footer className="footer footer-three dark:bg-background-8 bg-background-2 relative overflow-hidden">
  <div className="main-container">
    ...
    <figure
      ...
      className="pointer-events-none absolute top-[-237px] right-[-321px] block size-[600px] rotate-[-38deg] overflow-hidden select-none md:top-[-485px] md:right-[-693px] md:size-[1220px]"
    >
      <img
        src="./images/ns-img-524.png"
        alt="gradient-img"
      ...
      <div className="col-span-12 lg:col-span-4">
        <div data-ns-animate="" data-delay="0.3" className="xl:max-w-[306px]">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="bg-stroke-1 dark:bg-stroke-8 h-5 w-px" />
            <a href="#" className="footer-social-link">
      ...
      <div className="col-span-12 grid grid-cols-12 gap-x-0 gap-y-8 lg:col-span-8">
        <div className="col-span-12 md:col-span-4">
          <div data-ns-animate="" data-delay="0.4" className="space-y-8">
            ...
            <ul className="space-y-5">
              <li>
                <a href="./about.html" className="footer-link-v2">
                  {" "}
                  About Us{" "}
                </a>
              </li>
              <li>
                <a href="./career.html" className="footer-link-v2">
                  {" "}
                  Career{" "}
                </a>
              </li>
              <li>
                <a href="./case-study.html" className="footer-link-v2">
                  {" "}
                  Case Studies{" "}
                </a>
              </li>
              <li>
                <a href="./contact.html" className="footer-link-v2">
                  {" "}
                  Contact us{" "}
                </a>
              </li>
        ...
        <div className="col-span-12 md:col-span-4">
          <div data-ns-animate="" data-delay="0.5" className="space-y-8">
            ...
            <ul className="space-y-5">
              <li>
                <a href="./faq.html" className="footer-link-v2">
                  {" "}
                  FAQ{" "}
                </a>
              </li>
              <li>
                <a href="./documentation.html" className="footer-link-v2">
                  Documentation
                </a>
              </li>
              <li>
                <a href="./tutorial.html" className="footer-link-v2">
                  {" "}
                  Tutorial{" "}
                </a>
              </li>
              <li>
                <a href="./support.html" className="footer-link-v2">
                  {" "}
                  Support{" "}
                </a>
              </li>
        ...
        <div className="col-span-12 md:col-span-4">
          <div data-ns-animate="" data-delay="0.6" className="space-y-8">
            ...
            <ul className="space-y-5">
              <li>
                <a href="./terms-conditions.html" className="footer-link-v2">
                  Terms &amp; Conditions
                </a>
              </li>
              <li>
                <a href="./privacy-policy.html" className="footer-link-v2">
                  Privacy Policy
                </a>
              </li>
              <li>
                <a href="./refund-policy.html" className="footer-link-v2">
                  Refund Policy
                </a>
              </li>
              <li>
                <a href="./gdpr.html" className="footer-link-v2">
                  {" "}
                  GDPR Compliance{" "}
                </a>
              </li>
              <li>
                <a href="./affiliate-policy.html" className="footer-link-v2">
                  Affiliate Policy
                </a>
              </li>
            </ul>
    ...
    <div className="relative overflow-hidden pt-6 pb-[60px] text-center">
      <div className="footer-divider bg-stroke-2 dark:bg-accent/5 absolute top-0 right-0 left-0 mx-auto h-px w-0 origin-center" />
      <p
        data-ns-animate=""
        data-delay="0.7"
        data-offset={10}
      ...
      >
        Copyright ©Nexsas – smart application for modern business
      </p>
    </div>
  </div>
</footer>
      ...
      <Script src="/js/draw-svg.min.js" strategy="afterInteractive" />
      <Script src="/js/motionpathplugin.min.js" strategy="afterInteractive" />
      <Script src="/js/lenis.min.js" strategy="afterInteractive" />
      <Script src="/js/springer.min.js" strategy="afterInteractive" />
      <Script src="/js/number-counter.js" strategy="afterInteractive" />
